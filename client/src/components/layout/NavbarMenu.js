...
import learnIt from '../../assets/logo.svg'
    ...
    return (
        <Navbar expand='lg' bg='primary' variant='dark' className='shadow'>
            <Navbar.Brand className='font-weight-bolder text-white'>
                <img src={learnIt} alt="leanit" width={32} height={32} className="mr-2" />
                LearnIt
            </Navbar.Brand>
            ...
            <Navbar.Collapse id='basic-navbar-nav'>
                ...
                <Nav>
                    <Nav.Link className="font-weight-bolder text-white" to='/' disabled>
                        Welcome {username}
                    </Nav.Link>
